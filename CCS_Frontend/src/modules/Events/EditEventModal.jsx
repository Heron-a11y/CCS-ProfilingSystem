...
const EditEventModal = ({ isOpen, onClose, onSuccess, initialData }) => {
  ...
  const inputCls  = dark
    ...
    : 'bg-white border-slate-200 text-slate-700 placeholder-slate-400 focus:ring-brand-500/50';
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input type="text" name="eventName" value={formData.eventName} onChange={handleChange}
                placeholder="e.g. CCS IT Week 2026" required
            ...
            {/* Description */}
            <div>
              <label className={`block text-sm font-semibold mb-1 ${labelClr}`}>Description</label>
              <textarea name="description" value={formData.description} onChange={handleChange}
                placeholder="Brief details about the event..." rows="3"
                className={`w-full px-4 py-2.5 rounded-xl border focus:outline-none focus:ring-2 transition-all font-medium resize-none ${inputCls}`} />
            </div>
          </div>
